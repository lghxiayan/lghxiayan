...
DB_CONFIG = {
    ...
    'database': os.getenv('DB_NAME', 'db_book'),
    'autocommit': True,
    'charset': 'utf8mb4'
}

TABLE_NAME = 't_user'
WEB_COOKIE = [{'domain': 'ptvicomo.net', 'expiry': 1740792089, 'httpOnly': True, 'name': 'c_secure_login', 'path': '/',
               'sameSite': 'Lax', 'secure': False, 'value': 'bm9wZQ%3D%3D'},
              {'domain': 'ptvicomo.net', 'expiry': 1740792089, 'httpOnly': True, 'name': 'c_secure_tracker_ssl',
               'path': '/', 'sameSite': 'Lax', 'secure': False, 'value': 'eWVhaA%3D%3D'},
              {'domain': 'ptvicomo.net', 'expiry': 1740792089, 'httpOnly': True, 'name': 'c_secure_ssl', 'path': '/',
               'sameSite': 'Lax', 'secure': False, 'value': 'eWVhaA%3D%3D'},
              {'domain': 'ptvicomo.net', 'expiry': 1740792089, 'httpOnly': True, 'name': 'c_secure_pass', 'path': '/',
               'sameSite': 'Lax', 'secure': False, 'value': '14c96bacdf049a639abbe1b38199655d'},
              {'domain': 'ptvicomo.net', 'expiry': 1740792089, 'httpOnly': True, 'name': 'c_secure_uid', 'path': '/',

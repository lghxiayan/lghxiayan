...
class WoWJumpController:
    def __init__(self, ui):
        ...
        self.output_signal.output_writter.connect(self.append_output_to_textedit)
    ...
    def run_script(self, file_path):
        ...
        while True:
            ...
            if output:
                print(output.strip())
                self.output_signal.output_writter.emit(output.strip())
    ...
    def append_output_to_textedit(self, output):
        self.ui.plainTextEdit_wowjump_1.appendPlainText(output)
